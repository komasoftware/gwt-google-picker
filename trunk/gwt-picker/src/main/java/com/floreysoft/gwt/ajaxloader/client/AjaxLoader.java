 ...
 * the License.
 */
package com.floreysoft.gwt.ajaxloader.client;
...
public class AjaxLoader {
  ...
  public static class AjaxLoaderOptions extends JavaScriptObject {
    ...
    private native void setCallback(Runnable onLoad) /*-{
      ...
      @com.floreysoft.gwt.ajaxloader.client.ExceptionHelper::runProtected(Ljava/lang/Runnable;)(onLoad);
      }
    }-*/;
  }
  ...
  private static native boolean nativeCreateCallback() /*-{
    ...
    @com.floreysoft.gwt.ajaxloader.client.AjaxLoader::onLoadCallback()();
    }
