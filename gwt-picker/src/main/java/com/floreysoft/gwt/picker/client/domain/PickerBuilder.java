...
public final class PickerBuilder extends JavaScriptObject {
  ...
  public native PickerBuilder addView(ViewId viewId) /*-{
    return this.addView(viewId.@com.floreysoft.gwt.picker.client.domain.ViewId::getValue()());
  }-*/;
  ...
  public native PickerBuilder disableFeature(Feature feature) /*-{
    return this.disableFeature(feature.@com.floreysoft.gwt.picker.client.domain.Feature::getValue()());
  }-*/;
  ...
  public native PickerBuilder enableFeature(Feature feature) /*-{
    return this.enableFeature(feature.@com.floreysoft.gwt.picker.client.domain.Feature::getValue()());
  }-*/;
  ...
  public native boolean isFeatureEnabled(Feature feature) /*-{
    return this.isFeatureEnabled(feature.@com.floreysoft.gwt.picker.client.domain.Feature::getValue()());
  }-*/;
